function result = fitmodel_PT1alpha(indata)
...
[loglike, utildiff, logodds, probchoice] = prospecttheory_model(data);

end


function [loglike, utildiff, logodds, probchoice] = prospecttheory_model(data)
